package com.openlearnhub.riskbase.constant;
...
public class Constant {
  ...
  public static final String DISPLAY_TYPE = "Risk based";
  public static final String PROVIDER_HELP_TEXT = "Verifies whether it is a normal access pattern from the request information.";
